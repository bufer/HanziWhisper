...
- **快捷查询**：按住 Shift+Alt+Z 选中汉字，弹窗显示拼音、笔画、部首、释义、繁体字等信息
...
- [cnchar](https://github.com/theajack/cnchar)：汉字拼音、笔画、部首、释义、简繁转换、笔画动画
